...
Route::middleware('auth')->group(function () {
    ...
    /** API autocomplete hashtag */
    Route::get('/tags/search', [HashtagController::class, 'search'])->name('tags.search');

    /** Halaman pencarian hashtag (alias untuk /hashtag/{tag}) */
    Route::get('/search', [HashtagController::class, 'searchPage'])->name('search');
    ...
    /** Menambah REPLY ke komentar (nested comment) */
    Route::post('/posts/{postId}/comments/{parentId}/replies', [CommentController::class, 'store'])->name('comments.reply');
