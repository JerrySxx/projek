...
<head>
    ...
    <title>@yield('title', 'Violet')</title>
    ...
    <div>
        <div class="flex items-center gap-3 mb-10 px-2">
            <div class="w-10 h-10 rounded-2xl flex items-center justify-center" style="background: linear-gradient(135deg, rgba(236,72,153,0.2), rgba(168,85,247,0.15));">
                <img src="{{ asset('storage/profiles/logo.jpg') }}" alt="Violet" class="w-6 h-6 rounded-lg">
            </div>
        ...
        <div class="card card-glow p-4 mb-8 cursor-pointer">
            <div class="flex items-center gap-3">
                <div class="relative">
                    <img src="{{ Auth::user()->profile_photo_url }}" class="w-11 h-11 rounded-full ring-2 ring-pink-500/20">
