...
<body class="flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-10">
            ...
            <img src="<?php echo e(asset('storage/profiles/logo_bg.png')); ?>" alt="Violet" class="w-9 h-9 object-cover rounded-lg">
        </div>
            <h1 class="text-3xl font-extrabold tracking-tight">Selamat Datang Kembali</h1>
            <p class="text-gray-500 mt-2">Masuk untuk melanjutkan ke Violet</p>
        </div>
...
</html><?php /**PATH C:\laragon\www\violet\resources\views/auth/login.blade.php ENDPATH**/ ?>